...
typedef enum {
    ...
    /* Enable tracing for all transactions. This is the default. */
    /* Parameter: Option takes no parameter */
    FDB_DB_OPTION_DISTRIBUTED_TRANSACTION_TRACE_ENABLE=600,

    /* Disable tracing for all transactions. */
    /* Parameter: Option takes no parameter */
    FDB_DB_OPTION_DISTRIBUTED_TRANSACTION_TRACE_DISABLE=601,
